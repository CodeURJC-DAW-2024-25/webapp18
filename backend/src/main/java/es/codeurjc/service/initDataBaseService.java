...
public class initDataBaseService {
        ...
        private void initDatabase() throws IOException {
                ...
                // init apartmentes
                Apartment apartment1 = new Apartment("Apartment1", "apartment de plata", "loc1", 0F, null, manager1, new ArrayList<>(),
                                new ArrayList<>(), new ArrayList<>());

                Apartment apartment2 = new Apartment("Apartment2", "apartment ", "loc2", 0F, null, manager2, new ArrayList<>(),
                                new ArrayList<>(),
                                new ArrayList<>());

                Apartment apartment3 = new Apartment("Apartment3", "apartment ", "loc2", 0F, null, manager3, new ArrayList<>(),
                                new ArrayList<>(),
                                new ArrayList<>());

                Apartment apartment4 = new Apartment("Apartment4", "apartment ", "loc2", 0F, null, manager3, new ArrayList<>(),
                                new ArrayList<>(),
                                new ArrayList<>());

                Apartment apartment5 = new Apartment("Apartment5", "apartment ", "loc2", 0F, null, manager3, new ArrayList<>(),
                                new ArrayList<>(),
                                new ArrayList<>());

                Apartment apartment6 = new Apartment("Apartment6", "apartment ", "loc2", 0F, null, manager3, new ArrayList<>(),
                                new ArrayList<>(),
                                new ArrayList<>());

                Apartment apartment7 = new Apartment("Apartment7", "apartment ", "loc2", 0F, null, manager3, new ArrayList<>(),
                                new ArrayList<>(),
                                new ArrayList<>());
                ...
                setImage(apartment3, "/static/images/hotel2.jpg");
                setImage(apartment4, "/static/images/hotel4.jpg");
                setImage(apartment5, "/static/images/hotel3.jpg");
                setImage(apartment6, "/static/images/hotel4.jpg");
                setImage(apartment7, "/static/images/hotel6.jpg");
                setImage(apartment8, "/static/images/hortel5.jpg");
                setImage(apartment9, "/static/images/hotel6.jpg");
                setImage(apartment10, "/static/images/hotel4.jpg");
                setImage(apartment11, "/static/images/hotel.jpg");
                apartmentRepository.save(apartment1);
                apartmentRepository.save(apartment2);
                apartmentRepository.save(apartment3);
                apartmentRepository.save(apartment4);
